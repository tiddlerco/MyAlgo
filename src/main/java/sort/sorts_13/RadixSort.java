...
public class RadixSort {
    ...
    public long[] tel=new long[10];


    public long[] createTel() {
        for (int i = 0; i < 10; i++) {
            String strValue = RandomValue.getTel();
            long aLong = Long.parseLong(strValue);
            tel[i]=aLong;
        }
        return tel;
    }
